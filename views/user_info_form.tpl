      ...
      <div id="user-info-update">
        ...
        <div class="panel panel-default">
          ...
          <div class="panel-body">
            <form id="form-user-info" method="post" action="/update_user">
              <div class="form-group form-group-sm">
                <label for="inputId" class="sr-only">아이디</label>
                <input type="text" class="form-control" id="inputId" name="id" placeholder="{{info['user_id']}}" disabled />
              </div>
              <div class="form-group form-group-sm">
                <label for="inputName" class="sr-only">사용자명</label>
                <input type="text" class="form-control" id="inputName" name="name" value="{{info['user_name']}}" placeholder="사용자명" />
              </div>
              <div class="form-group form-group-sm">
              ...
              <div class="form-group form-group-sm">
                <label for="textareaIntro" class="sr-only"></label>
                <textarea class="form-control" rows="4" name="intro" placeholder="사용자 소개"></textarea>
              </div>
              <div class="form-group form-group-sm">
